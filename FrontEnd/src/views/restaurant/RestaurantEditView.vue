<template>
  ...
  <div class="profile-heading__content">
    ...
    <div>
      ...
      <p>
        Consulta y actualiza los datos del restaurante.
      </p>
    </div>
  </div>

  <button
    v-if="!loading && !modoEdicion"
  ...
  >
    ...
    >
      ...
      <p>
        Crea o selecciona un restaurante antes de consultar
        o editar su perfil.
      </p>
      ...
      >
        <div class="profile-card__header">
          <div class="restaurant-image">
            ...
            <div
              v-else
              class="restaurant-image__placeholder"
            >
              <Store :size="42" />
            </div>
          </div>
          ...
          <div>
            <h2>
              {{ formulario.nombre || "Restaurante" }}
            </h2>

            <span
              class="status-badge"
              :class="getEstadoClase(formulario.estado)"
            >
        ...
        <div class="profile-form">
          ...
          <fieldset
            class="delivery-fieldset form-field--full"
          >
          ...
          <div
            class="coordinates-section form-field--full"
          >
            <div class="coordinates-section__heading">
              <div>
                ...
                <p>
                  MongoDB utiliza longitud y latitud,
                  en ese orden.
                </p>
              </div>
            </div>
          ...
          <div class="schedule-section form-field--full">
            <div class="schedule-section__heading">
              <div>
                ...
                <p>
                  Indica la hora de apertura y cierre
                  para cada día.
                </p>
              </div>
            </div>
...
async function cargarDatos() {
  if (!idRestaurante) {
    error.value =
      "No se indicó el restaurante que se desea editar.";
...
function asignarRestauranteAlFormulario(restaurante) {
  ...
  Object.assign(formulario, {
    ...
    horario:
      normalizarHorario(restaurante.horario)
  });
}
...
function normalizarHorario(horario = {}) {
  ...
  Object.keys(horarioNormalizado).forEach(
    (dia) => {
      horarioNormalizado[dia] = {
        apertura:
          horario[dia]?.apertura || "",
...
async function guardarCambios() {
  try {
    ...
    if (!restauranteStore.idRestauranteActivo) {
      throw new Error(
        "Debes seleccionar un restaurante antes de guardar cambios."
      );
    }
...
function getEstadoClase(estado) {
  ...
  return `status-badge--${estado.toLowerCase()}`;
}
